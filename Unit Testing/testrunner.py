...
def test_check_credentials1():
  ...
  psw1 = "Qwerty$£@55"
  psw2 = "Qwerty$£@55"
  assert check_email(email) and check_psw(psw1) and check_psw_equal(psw1, psw2) is True
...
def test_check_credentials2():
  ...
  psw2 = "Qwerty$£@56"
  email = "myname326@gmail.com"
  assert check_email(email) and check_psw(psw1) and check_psw_equal(psw1, psw2) is False

# 6. Test that two equal passwords in the correct format and an incorrect email return false
def test_check_credentials3():
  psw1 = "Qwerty$£@56"
  psw2 = "Qwerty$£@56"
  email = "myname326@gmailcom"
  assert check_psw(psw1) and check_psw_equal(psw1, psw2)  and check_email(email) is False